...
"}")
        ...
        self.pb_feedback = QtWidgets.QPushButton(self.tab_codeinsight)
        self.pb_feedback.setObjectName("pb_feedback")
        self.evaluation_widgets.addWidget(self.pb_feedback)
...
" ")
    ...
    def retranslateUi(self, panelUI):
        ...
        self.pb_feedback.setText(_translate("panelUI", "Feedback"))
